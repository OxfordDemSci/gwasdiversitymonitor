...
def fill_document(doc, agency):
    ...
    with doc.create(Subsection('Diversity Statistics',
                               numbering=False)):
        doc.append('The total')

    with doc.create(Subsection('Insert Figure Here',
                               numbering=False)):
        doc.append('stats')

    with doc.create(Subsection('About the GWAS Diversity Monitor',
                               numbering=False)):
